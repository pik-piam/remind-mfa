...
def get_steel_prices(n_years):
    df_steel_prices = load_steel_prices()
    return _calc_price_projection_linear(n_years, df_steel_prices, cfg.percent_steel_price_change_2100)

def get_scrap_prices(n_years):
    df_scrap_prices = load_scrap_prices()
    return _calc_price_projection_linear(n_years, df_scrap_prices, cfg.percent_scrap_price_change_2100)


def _calc_price_projection_linear(n_years, df_prices, percent_price_change_2100):
