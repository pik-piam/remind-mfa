...
def get_definition(cfg: GeneralCfg, historic: bool) -> PlasticsMFADefinition:
    ...
    if historic:
        ...
        flows = [
            ...
            fd.FlowDefinition(from_process="fabrication", to_process="good_market", dim_letters=("t","e","r")),
            fd.FlowDefinition(from_process="good_market", to_process="exports", dim_letters=("t", "e", "r")),
            fd.FlowDefinition(from_process="imports", to_process="good_market", dim_letters=("t", "e", "r")),
            fd.FlowDefinition(from_process="good_market", to_process="use", dim_letters=("t","e","r","m")),
