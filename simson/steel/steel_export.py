...
class SteelDataExporter(CustomDataExporter):
    ...
    def visiualize_global_stock(
        ...
        self.visualize_global_stock_by_good(
            stock, x_array, population, x_label, y_label, title, per_capita
        )
        self.visualize_global_stock_by_region(stock, x_array, population, x_label, y_label, title, per_capita)

    def visualize_global_stock_by_good(
    ...
    def visualize_global_stock_by_region(self, stock, x_array, population, x_label, y_label, title, per_capita):
        ...
        ap_stock = self.plotter_class(
            ...
            area=False if per_capita else True,
        )

        self.plot_and_save_figure(ap_stock, f"stocks_global_by_region{'_per_capita' if per_capita else ''}.png")
