...
| customization.stock_extrapolation_class_name     | str                | PydanticUndefined       | Name of the extrapolation class to use for stock extrapolation.      |
| customization.lifetime_model_name                | str                | PydanticUndefined       | Name of the lifetime model to use.                                   |
