...
Besides the source code, the repository contains another folder for configuration files in TOML format. The configuration options are described [here](config.md).
...
The output data folder stores all model exports and visualizations.
