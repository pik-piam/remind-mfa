...
Similarly, after calculating local raw material demand from local production of end-use goods, this local demand is known for the raw material trade market as well, and imports, exports, and local production of end-use products have to be calculated together to fulfill Eq. \eqref{eq:trade_extrapol_massb}.
...
This means that exports are calculated first. They are still scaled with production, as in Eq. \eqref{eq:export_scaling_basic}. Imports are scaled with demand, as in Eq. \eqref{eq:import_scaling_basic}. Imports and demand are calculated concurrently with a fixed-point iteration.
