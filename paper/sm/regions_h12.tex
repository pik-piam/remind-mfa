\begin{longtable}{>{\raggedright\arraybackslash}p{0.06\linewidth}>{\raggedright\arraybackslash}p{0.15\linewidth}>{\raggedright\arraybackslash}p{0.7\linewidth}}
\caption{REMIND 12-region aggregation}\label{tab:regions_h12}\\
\toprule
Code & Name & Full list of countries \\
\midrule
\endfirsthead
\caption{REMIND 12-region aggregation (continued)}\\
\toprule
Code & Name & Full list of countries \\
\midrule
\endhead
